...
export const Results = () => {
    ...
    const fakeData = {
      ...
      "data": {
          ...
          "inline_twitter": [
              ...
              {
                  "tweet": "What @sequoia thought about @SBF_FTX and @FTX_Official. Try not to puke. archive.ph/qFJJN#select…",
  ...
  console.log (fakeData.data.organic_results[0].title)

      return (
        <div className="flex flex-wrap justify-between  sm:px-56">

          {fakeData?.data?.organic_results?.map(({url, title}, index) => (
